...
public class WeightEntry {
    ...
    public String getWName() { return wName.get(); }
    public void setWName(String value) { wName.set(value); }
    public StringProperty wNameProperty() { return wName; }

    public int getSets() { return sets.get(); }
    public void setSets(int value) { sets.set(value); }
    public IntegerProperty setsProperty() { return sets; }

    public int getReps() { return reps.get(); }
    public void setReps(int value) { reps.set(value); }
